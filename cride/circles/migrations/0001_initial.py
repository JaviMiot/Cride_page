    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_public', models.BooleanField(default=True, help_text='Public circles are listed in the main page so everyone know about thier existence.')),
                ...
                ('members_limit', models.PositiveIntegerField(default=0, help_text='if circleis limited this will be the limit on the number of members')),
            ],
            options={
