    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_admin', models.BooleanField(default=False, help_text="Circle admins can update tha circle's data and manage its members.", verbose_name='circle admin')),
                ...
                ('is_active', models.BooleanField(default=False, help_text='Only active users are allowed to interact in the circle', verbose_name='active status')),
